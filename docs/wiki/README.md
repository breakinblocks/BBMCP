...
BBMCP is a client-side development bridge for NeoForge 1.21.1. It starts a
...
`127.0.0.1`. BBMCP has no authentication layer; any process that can reach
...
FTB Quests and KubeJS are optional. BBMCP checks their loaded-mod state before
