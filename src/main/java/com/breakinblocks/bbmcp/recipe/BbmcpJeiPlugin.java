 ...
 */
@JeiPlugin
public final class BbmcpJeiPlugin implements IModPlugin {
    private static final ResourceLocation UID = ResourceLocation.fromNamespaceAndPath("bbmcp", "jei_plugin");
